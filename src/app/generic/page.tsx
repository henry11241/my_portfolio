        ...
        <section id="one">
          <div className="inner">
            ...
            <p>
              ...
              difficulties because I couldn't fully grasp the basic concepts due
              to the language barrier. I understood the logical parts while
              following the course, but when it came to writing code from
              scratch for assignments, I got stuck. I couldn't make any progress
